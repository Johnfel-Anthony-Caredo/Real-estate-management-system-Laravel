                ...
                <div class="col">
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <a href="#" class="btn btn-outline-success" data-toggle="modal" data-target="#addAdminModal">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    @foreach ($admins as $admin)
                                        <tr>
                                            <td class="text-success">{{ $admin->id }}</td>
                                            <td>{{ $admin->name }}</td>
                                            <td>{{ $admin->email }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{ route('admin.delete', $admin->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this admin?');">
                                                    @csrf
                                                    @method('DELETE')
