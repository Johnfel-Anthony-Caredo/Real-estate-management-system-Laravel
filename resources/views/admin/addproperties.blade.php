                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 style="font-size: 20px;" class="mb-0">Add New Property</h6>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('beds') is-invalid @enderror" type="number" id="beds" name="beds" value="{{ old('beds') }}">
                                            @error('beds')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('baths') is-invalid @enderror" type="number" id="baths" name="baths" value="{{ old('baths') }}">
                                            @error('baths')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('sq_ft') is-invalid @enderror" type="number" id="sq_ft" name="sq_ft" value="{{ old('sq_ft') }}">
                                            @error('sq_ft')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('home_type') is-invalid @enderror" id="home_type" name="home_type">
                                                ...
                                                @foreach($homeTypes as $type)
                                                    <option value="{{ $type->hometypes }}" {{ old('home_type') == $type->hometypes ? 'selected' : '' }}>{{ $type->hometypes }}</option>
                                                @endforeach
                                            </select>
                                            @error('home_type')
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('year_built') is-invalid @enderror" type="number" id="year_built" name="year_built" value="{{ old('year_built') }}">
                                            @error('year_built')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('price_sqft') is-invalid @enderror" type="number" step="0.01" id="price_sqft" name="price_sqft" value="{{ old('price_sqft') }}">
                                            @error('price_sqft')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('agent_name') is-invalid @enderror" type="text" id="agent_name" name="agent_name" value="{{ old('agent_name') }}">
                                            @error('agent_name')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('more_info') is-invalid @enderror" id="more_info" name="more_info" rows="4">{{ old('more_info') }}</textarea>
                                            @error('more_info')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <small class="form-text text-muted">This will be the main image displayed for the property.</small>
                            ...
                            <div class="form-group mt-4">
                                <label for="gallery" class="form-control-label">Gallery Images</label>
                                <div class="custom-file">
                                ...
                                <div class="mt-2">
                                    <button type="button" id="clearGallery" class="btn btn-sm btn-outline-danger">Clear All Images</button>
                                </div>
                            </div>
                            
                            <div class="alert alert-info mt-4">
                                <i class="fas fa-info-circle mr-2"></i> You'll be able to add more images after creating the property.
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function updateGalleryPreview() {
            ...
            if (selectedFiles.length > 0) {
                ...
                galleryPreview.innerHTML = '<div class="col-12 text-center text-muted"><p>No images selected</p></div>';
            }
        }
