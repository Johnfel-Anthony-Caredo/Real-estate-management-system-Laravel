                    ...
                    <div class="card">
                        <div class="card-header pb-0">
                            <div class="d-flex align-items-center justify-content-between">
                                <h6 style="font-size: 20px;" class="mb-0">Edit Admin</h6>
                                <a href="{{ route('admin.admins') }}" class="btn btn-primary btn-sm">Back to Admins</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <div class="col">
                                    <div class="card-profile-stats d-flex justify-content-center">
                                        <div class="text-center">
                                            ...
                                            <div class="h5 mt-5">
                                                <i class="ni business_briefcase-24 mr-2"></i>Admin ID: {{ $admin->id }}
                                            </div>
                                            <div>
                                                <i class="ni education_hat mr-2"></i>Joined: {{ \Carbon\Carbon::parse($admin->created_at)->format('M d, Y') }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
